...
export const responseAdditionalDataCardSchema: Schema<ResponseAdditionalDataCard> = object(
  {
    cardBin: ['cardBin', optional(string())],
    cardHolderName: ['cardHolderName', optional(string())],
    cardIssuingBank: ['cardIssuingBank', optional(string())],
    cardIssuingCountry: ['cardIssuingCountry', optional(string())],
    cardIssuingCurrency: ['cardIssuingCurrency', optional(string())],
    cardPaymentMethod: ['cardPaymentMethod', optional(string())],
    cardSummary: ['cardSummary', optional(string())],
    issuerBin: ['issuerBin', optional(string())],
  }
);
