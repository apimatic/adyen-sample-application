...
export const additionalDataAirlineSchema: Schema<AdditionalDataAirline> = object(
  {
    airlineAgencyInvoiceNumber: [
      'airline.agency_invoice_number',
      optional(string()),
    ],
    airlineAgencyPlanName: ['airline.agency_plan_name', optional(string())],
    airlineAirlineCode: ['airline.airline_code', optional(string())],
    airlineAirlineDesignatorCode: [
      'airline.airline_designator_code',
      optional(string()),
    ],
    airlineBoardingFee: ['airline.boarding_fee', optional(string())],
    ...
    airlineDocumentType: ['airline.document_type', optional(string())],
    airlineFlightDate: ['airline.flight_date', optional(string())],
    airlineLegCarrierCode: ['airline.leg.carrier_code', optional(string())],
    airlineLegClassOfTravel: [
      'airline.leg.class_of_travel',
      optional(string()),
    ],
    airlineLegDateOfTravel: ['airline.leg.date_of_travel', optional(string())],
    airlineLegDepartAirport: ['airline.leg.depart_airport', optional(string())],
    airlineLegDepartTax: ['airline.leg.depart_tax', optional(string())],
    airlineLegDestinationCode: [
      'airline.leg.destination_code',
      optional(string()),
    ],
    airlineLegFareBaseCode: ['airline.leg.fare_base_code', optional(string())],
    airlineLegFlightNumber: ['airline.leg.flight_number', optional(string())],
    airlineLegStopOverCode: ['airline.leg.stop_over_code', optional(string())],
    ...
    airlinePassengerName: ['airline.passenger_name', string()],
    airlineTicketIssueAddress: [
      'airline.ticket_issue_address',
      optional(string()),
    ],
    airlineTicketNumber: ['airline.ticket_number', optional(string())],
    airlineTravelAgencyCode: ['airline.travel_agency_code', optional(string())],
    airlineTravelAgencyName: ['airline.travel_agency_name', optional(string())],
  }
);
