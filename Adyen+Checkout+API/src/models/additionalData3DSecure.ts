...
export const additionalData3DSecureSchema: Schema<AdditionalData3DSecure> = object(
  {
    allow3DS2: ['allow3DS2', optional(string())],
    challengeWindowSize: [
      'challengeWindowSize',
      optional(challengeWindowSizeEnumSchema),
    ],
    executeThreeD: ['executeThreeD', optional(string())],
    mpiImplementationType: ['mpiImplementationType', optional(string())],
    scaExemption: ['scaExemption', optional(string())],
