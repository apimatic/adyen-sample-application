...
import {
  IndustryUsageEnum,
  industryUsageEnumSchema,
} from './industryUsageEnum';
...
export interface AdditionalDataCommon {
   ...
   */
  industryUsage?: IndustryUsageEnum;
  /**
...
export const additionalDataCommonSchema: Schema<AdditionalDataCommon> = object({
  requestedTestErrorResponseCode: [
    'RequestedTestErrorResponseCode',
    optional(string()),
  ],
  authorisationType: ['authorisationType', optional(string())],
  customRoutingFlag: ['customRoutingFlag', optional(string())],
  industryUsage: ['industryUsage', optional(industryUsageEnumSchema)],
  networkTxReference: ['networkTxReference', optional(string())],
  overwriteBrand: ['overwriteBrand', optional(string())],
  subMerchantCity: ['subMerchantCity', optional(string())],
  subMerchantCountry: ['subMerchantCountry', optional(string())],
  subMerchantID: ['subMerchantID', optional(string())],
  subMerchantName: ['subMerchantName', optional(string())],
  subMerchantPostalCode: ['subMerchantPostalCode', optional(string())],
  subMerchantState: ['subMerchantState', optional(string())],
  subMerchantStreet: ['subMerchantStreet', optional(string())],
  subMerchantTaxId: ['subMerchantTaxId', optional(string())],
});
