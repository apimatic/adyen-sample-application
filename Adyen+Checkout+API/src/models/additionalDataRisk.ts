...
export const additionalDataRiskSchema: Schema<AdditionalDataRisk> = object({
  riskdataCustomFieldName: ['riskdata.[customFieldName]', optional(string())],
  ...
  riskdataSkipRisk: ['riskdata.skipRisk', optional(string())],
});
