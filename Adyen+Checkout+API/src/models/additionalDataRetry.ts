...
export const additionalDataRetrySchema: Schema<AdditionalDataRetry> = object({
  retryChainAttemptNumber: ['retry.chainAttemptNumber', optional(string())],
  retryOrderAttemptNumber: ['retry.orderAttemptNumber', optional(string())],
  retrySkipRetry: ['retry.skipRetry', optional(string())],
});
