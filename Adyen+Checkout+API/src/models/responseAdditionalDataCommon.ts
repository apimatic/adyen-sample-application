...
import {
  FraudResultTypeEnum,
  fraudResultTypeEnumSchema,
} from './fraudResultTypeEnum';
import {
  RecurringProcessingModel7Enum,
  recurringProcessingModel7EnumSchema,
} from './recurringProcessingModel7Enum';
...
export interface ResponseAdditionalDataCommon {
  ...
  fraudResultType?: FraudResultTypeEnum;
  /**
  ...
  recurringProcessingModel?: RecurringProcessingModel7Enum;
  /**
...
export const responseAdditionalDataCommonSchema: Schema<ResponseAdditionalDataCommon> = object(
  {
    acquirerAccountCode: ['acquirerAccountCode', optional(string())],
    acquirerCode: ['acquirerCode', optional(string())],
    acquirerReference: ['acquirerReference', optional(string())],
    alias: ['alias', optional(string())],
    aliasType: ['aliasType', optional(string())],
    authCode: ['authCode', optional(string())],
    authorisationMid: ['authorisationMid', optional(string())],
    authorisedAmountCurrency: ['authorisedAmountCurrency', optional(string())],
    authorisedAmountValue: ['authorisedAmountValue', optional(string())],
    avsResult: ['avsResult', optional(string())],
    avsResultRaw: ['avsResultRaw', optional(string())],
    bic: ['bic', optional(string())],
    coBrandedWith: ['coBrandedWith', optional(string())],
    cvcResult: ['cvcResult', optional(string())],
    cvcResultRaw: ['cvcResultRaw', optional(string())],
    dsTransID: ['dsTransID', optional(string())],
    eci: ['eci', optional(string())],
    expiryDate: ['expiryDate', optional(string())],
    extraCostsCurrency: ['extraCostsCurrency', optional(string())],
    extraCostsValue: ['extraCostsValue', optional(string())],
    fraudCheckItemNrFraudCheckname: [
      'fraudCheck-[itemNr]-[FraudCheckname]',
      optional(string()),
    ],
    fraudManualReview: ['fraudManualReview', optional(string())],
    fraudResultType: ['fraudResultType', optional(fraudResultTypeEnumSchema)],
    fundingSource: ['fundingSource', optional(string())],
    fundsAvailability: ['fundsAvailability', optional(string())],
    inferredRefusalReason: ['inferredRefusalReason', optional(string())],
    isCardCommercial: ['isCardCommercial', optional(string())],
    issuerCountry: ['issuerCountry', optional(string())],
    liabilityShift: ['liabilityShift', optional(string())],
    mcBankNetReferenceNumber: ['mcBankNetReferenceNumber', optional(string())],
    merchantAdviceCode: ['merchantAdviceCode', optional(string())],
    ...
    paymentMethodVariant: ['paymentMethodVariant', optional(string())],
    payoutEligible: ['payoutEligible', optional(string())],
    realtimeAccountUpdaterStatus: [
      'realtimeAccountUpdaterStatus',
      optional(string()),
    ],
    receiptFreeText: ['receiptFreeText', optional(string())],
    recurringContractTypes: ['recurring.contractTypes', optional(string())],
    ...
    recurringProcessingModel: [
      'recurringProcessingModel',
      optional(recurringProcessingModel7EnumSchema),
    ],
    referred: ['referred', optional(string())],
    refusalReasonRaw: ['refusalReasonRaw', optional(string())],
    requestAmount: ['requestAmount', optional(string())],
    requestCurrencyCode: ['requestCurrencyCode', optional(string())],
    shopperInteraction: ['shopperInteraction', optional(string())],
    shopperReference: ['shopperReference', optional(string())],
    terminalId: ['terminalId', optional(string())],
    threeDAuthenticated: ['threeDAuthenticated', optional(string())],
    threeDAuthenticatedResponse: [
      'threeDAuthenticatedResponse',
      optional(string()),
    ],
    threeDOffered: ['threeDOffered', optional(string())],
    threeDOfferedResponse: ['threeDOfferedResponse', optional(string())],
    threeDSVersion: ['threeDSVersion', optional(string())],
    visaTransactionId: ['visaTransactionId', optional(string())],
