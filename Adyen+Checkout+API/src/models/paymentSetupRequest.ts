...
import { Configuration1, configuration1Schema } from './configuration1';
...
export const paymentSetupRequestSchema: Schema<PaymentSetupRequest> = object({
  ...
  configuration: ['configuration', optional(lazy(() => configuration1Schema))],
