...
export interface PaymentDonationRequest {
  /**
...
export const paymentDonationRequestSchema: Schema<PaymentDonationRequest> = object(
  {
    ...
    donationAccount: ['donationAccount', string()],
