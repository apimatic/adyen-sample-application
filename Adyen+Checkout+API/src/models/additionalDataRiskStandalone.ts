...
export const additionalDataRiskStandaloneSchema: Schema<AdditionalDataRiskStandalone> = object(
  {
    payPalCountryCode: ['PayPal.CountryCode', optional(string())],
    payPalEmailId: ['PayPal.EmailId', optional(string())],
    payPalFirstName: ['PayPal.FirstName', optional(string())],
    payPalLastName: ['PayPal.LastName', optional(string())],
    payPalPayerId: ['PayPal.PayerId', optional(string())],
    payPalPhone: ['PayPal.Phone', optional(string())],
    payPalProtectionEligibility: [
      'PayPal.ProtectionEligibility',
      optional(string()),
    ],
    payPalTransactionId: ['PayPal.TransactionId', optional(string())],
    avsResultRaw: ['avsResultRaw', optional(string())],
    bin: ['bin', optional(string())],
    cvcResultRaw: ['cvcResultRaw', optional(string())],
    riskToken: ['riskToken', optional(string())],
    threeDAuthenticated: ['threeDAuthenticated', optional(string())],
    threeDOffered: ['threeDOffered', optional(string())],
    tokenDataType: ['tokenDataType', optional(string())],
  }
);
