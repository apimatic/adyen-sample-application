...
import { ServiceError22, serviceError22Schema } from './serviceError22';
...
export interface PaymentVerificationResponse {
  ...
  serviceError?: ServiceError22;
  /** The shopperLocale value provided in the payment request. */
  shopperLocale: string;
}

export const paymentVerificationResponseSchema: Schema<PaymentVerificationResponse> = object(
  {
    ...
    serviceError: ['serviceError', optional(lazy(() => serviceError22Schema))],
    shopperLocale: ['shopperLocale', string()],
  }
);
