...
export const storedPaymentMethodResourceSchema: Schema<StoredPaymentMethodResource> = object(
  {
    brand: ['brand', optional(string())],
    expiryMonth: ['expiryMonth', optional(string())],
    expiryYear: ['expiryYear', optional(string())],
    externalResponseCode: ['externalResponseCode', optional(string())],
    externalTokenReference: ['externalTokenReference', optional(string())],
