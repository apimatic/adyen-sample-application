...
| `body` | [`CardDetailsRequest \| undefined`](../../doc/models/card-details-request.md) | Body, Optional | - |
...
try {
  const { result, ...httpResponse } = await paymentsController.postCardDetails(idempotencyKey, body);
...
|  --- | --- | --- | --- |
| `idempotencyKey` | `string \| undefined` | Header, Optional | A unique identifier for the message with a maximum of 64 characters (we recommend a UUID). |
| `body` | [`PaymentDonationRequest \| undefined`](../../doc/models/payment-donation-request.md) | Body, Optional | - |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`DonationResponse`](../../doc/models/donation-response.md)
...
const idempotencyKey = '37ca9c97-d1d1-4c62-89e8-706891a563ed';
try {
  const { result, ...httpResponse } = await paymentsController.postDonations(idempotencyKey);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch(error) {
  if (error instanceof ApiError) {
...
|  --- | --- | --- | --- |
| `idempotencyKey` | `string \| undefined` | Header, Optional | A unique identifier for the message with a maximum of 64 characters (we recommend a UUID). |
| `body` | [`PaymentMethodsRequest \| undefined`](../../doc/models/payment-methods-request.md) | Body, Optional | - |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |
...
const contentType = null;
const idempotencyKey = '37ca9c97-d1d1-4c62-89e8-706891a563ed';
const body: PaymentMethodsRequest = {
  merchantAccount: 'YOUR_MERCHANT_ACCOUNT',
};

try {
  const { result, ...httpResponse } = await paymentsController.postPaymentMethods(idempotencyKey, body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch(error) {
  if (error instanceof ApiError) {
...
|  --- | --- | --- | --- |
| `idempotencyKey` | `string \| undefined` | Header, Optional | A unique identifier for the message with a maximum of 64 characters (we recommend a UUID). |
| `body` | [`PaymentRequest \| undefined`](../../doc/models/payment-request.md) | Body, Optional | - |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |
...
const body: PaymentRequest = {
  amount: bodyAmount,
  merchantAccount: 'YOUR_MERCHANT_ACCOUNT',
  paymentMethod: '{"type":"applepay","applePayToken":"VNRWtuNlNEWkRCSm1xWndjMDFFbktkQU..."}',
  reference: 'Your order number',
  returnUrl: 'https://your-company.com/...',
};

try {
  const { result, ...httpResponse } = await paymentsController.postPayments(idempotencyKey, body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch(error) {
  if (error instanceof ApiError) {
...
|  --- | --- | --- | --- |
| `idempotencyKey` | `string \| undefined` | Header, Optional | A unique identifier for the message with a maximum of 64 characters (we recommend a UUID). |
| `body` | [`DetailsRequest \| undefined`](../../doc/models/details-request.md) | Body, Optional | - |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |
...
const contentType = null;
const idempotencyKey = '37ca9c97-d1d1-4c62-89e8-706891a563ed';
const bodyDetails: PaymentCompletionDetails2 = {};
bodyDetails.threeDSResult = 'eyJ0cmFuc1N0YXR1cyI6IlkifQ==';

const body: DetailsRequest = {
  details: bodyDetails,
};

try {
  const { result, ...httpResponse } = await paymentsController.postPaymentsDetails(idempotencyKey, body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch(error) {
  if (error instanceof ApiError) {
...
|  --- | --- | --- | --- |
| `idempotencyKey` | `string \| undefined` | Header, Optional | A unique identifier for the message with a maximum of 64 characters (we recommend a UUID). |
| `body` | [`CreateCheckoutSessionRequest \| undefined`](../../doc/models/create-checkout-session-request.md) | Body, Optional | - |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |
...
try {
  const { result, ...httpResponse } = await paymentsController.postSessions(idempotencyKey, body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch(error) {
  if (error instanceof ApiError) {
